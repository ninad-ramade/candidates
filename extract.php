...
function sendEmail($email) {
    ...
    $content = 'Hi, ' . $username . ',<br/><br/>Please click below link to fill up the form.<br/><br/><a href="http://' . $_SERVER['SERVER_NAME'] . '?ce=' . base64_encode($email) . '" target="blank">Click Here</a><br/><br/>Thanks<br/><br/>RT Jobs';
